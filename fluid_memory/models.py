...
class MemoryItem(BaseModel):
    ...
    # Invalidation (logical delete)
    invalidated_at: Optional[float] = Field(default=None, description="Timestamp when invalidated")
    invalidation_reason: Optional[str] = Field(default=None, description="Reason for invalidation")
    state_checksum: Optional[str] = Field(default=None, description="Checksum for state validation")
